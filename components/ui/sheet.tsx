...
function SheetOverlay({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Overlay>) {
  return (
    <SheetPrimitive.Overlay data-slot="sheet-overlay" className={cn(sheetOverlayClassName, className)} {...props} />
  )
}
...
function SheetContent({
  ...
  return (
    <SheetPortal>
      {overlayHref ? (
        <SheetPrimitive.Overlay data-slot="sheet-overlay" asChild>
          <Link
            href={overlayHref}
